                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-12 col-md-4">
                            ...
                            <p class="custom-font-6-bold text-center card-name mt-1"></p>
                            <div class="card">
                                <div class="card-body custom-font-4">
                                    <p class="card-text card-mail"><b><i class="fad fa-envelope-open text-gray-700 mr-2"></i>Email:</b> minhoccho@gmail.com</p>
                                    <p class="card-text card-phone"><b><i class="fad fa-phone-alt text-gray-700 mr-2"></i>Phone:</b> </p>
                                <p class="card-text card-address"><b><i class="fad fa-car-building text-gray-700 mr-2"></i>Address:</b> </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-8">
                            <ul class="timeline custom-font-4">
                                <p class="custom-font-6-bold text-gray-700" style="padding-left: 60px;">Activity</p>
                                <li>
        ...
        function gogogo() {
            ...
            $.ajax({
                ...
                success: function(recieved) {
                    ...
                    $('.card-address').append(cus.address + ", " + cus.city);
                    $('.card-email').append(cus.email);
                    $('.card-phone').append(cus.phone);
                    $('.card-name').html(cus.firstName + " " + cus.lastName);
                    $('.card-avt').attr('src', cus.avatar);
                }
            });
        }
        gogogo();
