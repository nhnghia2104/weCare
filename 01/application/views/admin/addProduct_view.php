        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container mt-5">
                    ...
                    <h5 class="font-weight-bold ml-md-5 mr-md-5 text-center" style="color:#4e73df;">
                        ADD NEW PRODUCT
                    </h5>
                    <div class="ml-md-5 mr-md-5 mb-5">
                        <form method="post" enctype="multipart/form-data"
                            action="<?php echo base_url(); ?>index.php/admin/Product/insertProduct">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-12 col-form-label font-weight-bold">* Product's
                                            name</label>
                                        <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label class="col-12 col-lg-12 col-form-label font-weight-bold">*
                                                Category</label>
                                            <!-- ID Category -->
                                        ...
                                        <!-- Input price -->
                                        <div class="form-group col-lg-6">
                                            <label class="col-lg-12 col-form-label font-weight-bold">* Price</label>
                                    ...
                                    <!-- Input description -->
                                    <div class="form-group">
                                        <label class="col-lg-12 col-form-label font-weight-bold">* Description</label>
                                        <div class="col-lg-12">
                                            <textarea class="form-control border-0" id="product-description" rows="10"
                                                name="product-description" placeholder="Description"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <span class="switch switch-sm offset-1">
                                            <input name="product-status" type="checkbox" class="switch"
                                                id="switch-status" onclick="statusChange();" value="0">
                                            <label id="statusLabel" for="switch-status" style="color:#6e707e">Active</label>
                                        </span>
                                    </div>
                                    <!-- end status -->
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <!-- Input Image -->
                                    <div class="form-group">
                                        <label class="col-lg-12 col-form-label font-weight-bold">* Image</label>
                                        <div class="col-lg-12">
                            ...
                            <div class="float-right">
                                <a class="btn btn-primary" type="button"
                                    href="<?php echo base_url(); ?>index.php/admin/Product/cancel">Cancel</a>
