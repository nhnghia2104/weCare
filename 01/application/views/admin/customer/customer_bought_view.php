...
<body id="page-top">
                ...
                <div class="container mt-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p class="custom-font-6 mt-3 mb-2">Bought List</p>
                        </div>
                        <div class="col-12">
    ...
    <script>
        ...
        function gogogo() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>index.php/admin/UserManage/listCustomerBought/' + id,
                dataType: 'json',
                data: {
                    id: id,
                },
        ...
        function displayProfile(data) {
            ...
            gender = data.gender;
            gender == 0 ? $('#info_male').html('Male') : $('#info_female').html('Female');
        }
        ...
        function template(data) {
            ...
            for (i = 0; i < data.length; i++) {
                html += '<div class="col-12 col-md-3 custom-font-4">' +
                    '<img width="100%" class="p-5" src="' + data[i].Image + '" alt="">' +
                    '<p class="text-center mb-0">' + data[i].DisplayName + '</p>' +
                    '<a href="<?php echo base_url(); ?>index.php/admin/productmanage/info/' + data[i].idProduct + '"><p class="text-center">' + data[i].idProduct + '</p><a>' +
                    '</div>';
            }
            return html;
        }
