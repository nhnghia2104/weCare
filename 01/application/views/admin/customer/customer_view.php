        ...
        <ul class="navbar-nav bg-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseCustomer" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="<?php echo base_url(); ?>index.php/admin/usermanage">
                    ...
                    <div class="card rounded-0 mb-4">
                        ...
                        <div class="card-body custom-font-3">
                            <div class="table-responsive">
                                <table class="table table-hover" id="tableCustomer" width="100%" cellspacing="0">
                                    <thead class="">
                                        <tr>
                                            <th>ID</th>
                                            <th>Name</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tableCustomer tbody').on('click', 'tr', function() {
                ...
                id = data[0];
                window.location.href = "<?php echo base_url(); ?>index.php/admin/usermanage/info?id=" + id;
            });
            ...
            $.ajax({
                type: "GET",
                url: '<?php echo base_url(); ?>index.php/admin/userManage/getListCustomers',
                dataType: 'json',
            ...
            function displayTable(array) {
                for (var index = 0; index < array.length; index++) {
                    oTable.row.add([
                        ...
                        array[index].gender == 0 ? 'Male' : 'Female',
                        array[index].email,
                        array[index].phone,
                        array[index].order,
                    ])
