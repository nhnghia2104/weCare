        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container mt-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a class="custom-font-4 back_btn" href="#">
                                <i class="fad fa-backward"></i> Customer Infomation</a>
                            <p class="custom-font-6 mt-3 mb-2">Sale Order List</p>
                        </div>
                        <div class="col-12">
    ...
    <script>
        ...
        function pushDataTable(array) {
            ...
            for (var index = 0; index < array.length; index++) {
                ...
                oTable.row.add([
                    '<a href="<?php echo base_url(); ?>index.php/admin/ordersmanage/detail?id=' + array[index].id + '">' + array[index].id + '</a>',
