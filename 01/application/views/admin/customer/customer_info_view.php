...
<body id="page-top">
                                ...
                                <div class="card-body custom-font-4">
                                    <div class="container-fluid p-0">
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="">
                                                    <img style="height:auto; width:100%;" src="http://localhost:2104/01/FilesUpload/default-avatar.png" onError="this.onerror=null;this.src='http://localhost:2104/01/FilesUpload/default-avatar.png';" class="card-avt img-rounded border rounded-circle">
                                                </div>
                                            </div>
                                            <div class="col-9">
                                                <p id="user_id">#123123</p>
                                                <p class="row"><span class="col-3 custom-font-weight-bold">Full name: </span><span id="info-name"></span></p>
                                                <p class="row"><span class="col-3 custom-font-weight-bold">Email: </span><span id="info-email"></span></p>
                                                <p class="row"><span class="col-3 custom-font-weight-bold">Phone: </span><span id="info-phone"></span></p>
                                                <p class="row"><span class="col-3 custom-font-weight-bold">Birthday: </span><span id="info_birthday"></span></p>
                                                <p class="row"><span class="col-3 custom-font-weight-bold">Gender: </span><span id="info_gender"></span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-deck">
                                <div class="card rounded-0">
                                    <div class="card-body text-center p-5">
                                        <a href="userbought?id=1605209792979" class="userbought text-info custom-font-6-bold">
                                            <img width="100%" class="p-5" src="https://www.flaticon.com/svg/static/icons/svg/1360/1360174.svg" alt="bought">
                                            <p>Bought</p>
                                        </a>
                                    </div>
                                </div>
                                <div class="card rounded-0">
                                    <div class="card-body text-center p-5">
                                        <a href="userordered?id=1605209792979" class="userordered text-info custom-font-6-bold">
                                            <img width="100%" class="p-5" src="https://www.flaticon.com/svg/static/icons/svg/1360/1360188.svg" alt="order">
                                            <p>Orders</p>
                                        </a>
                                    </div>
                                </div>
                                <div class="card rounded-0">
                                    <div class="card-body text-center p-5">
                                        <a href="userfeedback?id=1605209792979" class="userfeedback text-info custom-font-6-bold">
                                            <img width="100%" class="p-5" src="https://www.flaticon.com/svg/static/icons/svg/1360/1360146.svg" alt="bought">
    ...
    <script>
        ...
        function gogogo() {
            ...
            var id = data.id[0];
            $('.userbought').attr('href', 'userbought?id=' + id);
            $('.userordered').attr('href', 'userordered?id=' + id);
            $('.userfeedback').attr('href', 'userfeedback?id=' + id);
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>index.php/admin/UserManage/getDetailCustomer/' + id,
                dataType: 'json',
                data: {
                    id: id,
                },
        ...
        function displayProfile(data) {
            $('#info-name').html(data.firstName + ' ' + data.lastName);

            $('#info-email').html(data.email);
            $('#info-phone').html(data.phone);
            $('#user_id').html('#' + data.id);
            $('.card-avt').attr('src', data.avatar);

            birthday = new Date().setTime(data.birthday);
            $('#info_birthday').html(dateFormatShort(birthday));

            gender = data.gender;
            gender == 0 ? $('#info_gender').html('Male') : $('#info_gender').html('Female');
        }
    </script>
