...
<body>
        ...
        <div class="container text-left">
            <div class="row border-bottom">
                ...
                <div class="col-12 col-sm-3 offset-sm-6">
                    <div class="dropdown custom-font-4 text-right">
                        <button class="btn btn-outline-info dropdown-toggle border-0 rounded-0" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Most popular
                        </button>
                        <div class="dropdown-menu rounded-0" aria-labelledby="dropdownMenuButton">
                            ...
                            <a id="dropdown-1" class="dropdown-item drop_change" data-val="1">Most popular</a>
                            <a id="dropdown-2" class="dropdown-item drop_change" data-val="2">Highest price</a>
                            <a id="dropdown-3" class="dropdown-item drop_change" data-val="3">Lowest price</a>
                        </div>
                    </div>
                </div>
    ...
    <script>
                    ...
                    if (src == '') {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                console.log(sortData(response, defaultSorted));
                                done(sortData(response, defaultSorted));
                            }
                        });
                    } else {
                        $.ajax({
                            type: 'POST',
                            url: 'shop/getProductActiveWithCategory_ajax',
                            dataType: 'json',
                            data: {
                                src: src
                            },
        ...
        $('.drop_change').click(function() {
            defaultSorted = $(this).data('val');
            $('#pagination-container').pagination('destroy');
            $('#dropdownMenuButton').html($('#dropdown-' + defaultSorted).html())
            console.log(defaultSorted);
            goPagination();
        })
        ...
        function sortData(data, value) {
            ...
            switch (value) {
                ...
                case 2: // Highest Price
                    return data.sort((a, b) => (parseFloat(b.Price) * (1 - parseFloat(b.discount))) - (parseFloat(a.Price) * (1 - parseFloat(a.discount))));
                    break;
                case 3: // Lowest Price
                    return data.sort((a, b) => (parseFloat(a.Price) * (1 - parseFloat(a.discount))) - (parseFloat(b.Price) * (1 - parseFloat(b.discount))));
                    break;
            }
            console.log('ngon');
            return data;
